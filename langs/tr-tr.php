...
$s['no'] = 'Hayır';
$s['yes'] = 'Evet';
$s['latestExperimentalRelease'] = 'En son Deneysel Kanal derlemesi';
$s['latestExperimentalReleaseSub'] = 'Yeni fikirler ve uzun vadeli özellikler içeren, biraz güvenilmez derlemeler. Meraklı kullanıcılar için idealdir.';
$s['latestFuturePlatformsRelease'] = 'En son Gelecek Platformları derlemesi';
$s['latestFuturePlatformsReleaseSub'] = 'En yeni platform değişikliklerini ve erken özellikleri içeren, biraz kararsız derlemeler. Teknik düzeyi yüksek kullanıcılar için idealdir.';
