...
$s['latestExperimentalRelease'] = '最新の実験チャネルビルド';
$s['latestExperimentalReleaseSub'] = '新しいアイデアと長期的な機能を含む、やや不安定なビルドです。愛好家に最適です。';
$s['latestFuturePlatformsRelease'] = '最新の将来のプラットフォームビルド';
$s['latestFuturePlatformsReleaseSub'] = 'プラットフォームの最新の変更と初期機能を含む、やや不安定なビルドです。高度な技術ユーザーに最適です。';
