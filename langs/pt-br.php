...
$s['latestExperimentalReleaseSub'] = 'Compilações um tanto instáveis com novas ideias e recursos de longo prazo. Ideais para entusiastas.';
$s['latestFuturePlatformsRelease'] = 'Compilação mais recente das Plataformas Futuras';
$s['latestFuturePlatformsReleaseSub'] = 'Compilações um tanto instáveis com as alterações mais recentes da plataforma e recursos iniciais. Ideais para usuários altamente técnicos.';
