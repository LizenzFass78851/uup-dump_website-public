...
$s['no'] = '아니오';
$s['yes'] = '예';
$s['latestExperimentalRelease'] = '최신 실험 채널 빌드';
$s['latestExperimentalReleaseSub'] = '새로운 아이디어와 장기 기능이 포함된 다소 불안정한 빌드입니다. 애호가에게 적합합니다.';
$s['latestFuturePlatformsRelease'] = '최신 미래 플랫폼 빌드';
$s['latestFuturePlatformsReleaseSub'] = '최신 플랫폼 변경 사항과 초기 기능이 포함된 다소 불안정한 빌드입니다. 고급 기술 사용자에게 적합합니다.';
