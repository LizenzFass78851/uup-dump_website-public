...
$s['latestExperimentalRelease'] = '最新实验频道版本';
$s['latestExperimentalReleaseSub'] = '包含新想法和长期功能的稍不稳定版本。适合爱好者。';
$s['latestFuturePlatformsRelease'] = '最新未来平台版本';
$s['latestFuturePlatformsReleaseSub'] = '包含最新平台更改和早期功能的稍不稳定版本。适合技术水平较高的用户。';
...
$s['newBuildUsingText'] = '此页面旨在供希望添加在网站上找不到的版本的高级用户使用。如果你想使用最常用的参数之一，请使用首页上的<i>快速选项</i>之一。';
...
$s['selLangFiles'] = '文件';
$s['allFiles'] = '所有文件';
$s['wubOnly'] = '仅 WindowsUpdateBox';
$s['updateOnly'] = '仅更新';
$s['selectLangInfoText1'] = '单击<i>下一步</i>按钮选择你要下载的版本。';
$s['selectLangInfoText2'] = 'WindowsUpdateBox.exe 和累积更新可以在<i>所有语言</i>中找到。';
$s['allLangsWarn'] = '<i>所有语言</i>选项不支持 SKU 版本选择。';
