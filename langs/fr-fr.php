...
$s['no'] = 'Non';
$s['yes'] = 'Oui';
$s['latestExperimentalRelease'] = 'Dernière build du canal expérimental';
$s['latestExperimentalReleaseSub'] = 'Builds assez peu fiables avec de nouvelles idées et des fonctionnalités à long terme. Idéales pour les passionnés.';
$s['latestFuturePlatformsRelease'] = 'Dernière build des plateformes futures';
$s['latestFuturePlatformsReleaseSub'] = 'Builds assez instables avec les dernières modifications de la plateforme et des fonctionnalités préliminaires. Idéales pour les utilisateurs très techniques.';
