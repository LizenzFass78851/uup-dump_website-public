...
$s['latestExperimentalRelease'] = 'Compilação mais recente do Canal Experimental';
$s['latestExperimentalReleaseSub'] = 'Compilações algo instáveis com novas ideias e funcionalidades de longo prazo. Ideais para entusiastas.';
$s['latestFuturePlatformsRelease'] = 'Compilação mais recente das Plataformas Futuras';
$s['latestFuturePlatformsReleaseSub'] = 'Compilações algo instáveis com as alterações mais recentes da plataforma e funcionalidades iniciais. Ideais para utilizadores altamente técnicos.';
