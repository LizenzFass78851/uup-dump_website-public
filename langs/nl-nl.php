...
$s['no'] = 'Nee';
$s['yes'] = 'Ja';
$s['latestExperimentalRelease'] = 'Nieuwste build van het experimentele kanaal';
$s['latestExperimentalReleaseSub'] = 'Enigszins onbetrouwbare builds met nieuwe ideeen en functies voor de lange termijn. Ideaal voor liefhebbers.';
$s['latestFuturePlatformsRelease'] = 'Nieuwste build van toekomstige platformen';
$s['latestFuturePlatformsReleaseSub'] = 'Enigszins instabiele builds met de nieuwste platformwijzigingen en vroege functies. Ideaal voor zeer technische gebruikers.';
