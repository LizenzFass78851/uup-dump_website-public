...
$s['no'] = 'Nem';
$s['yes'] = 'Igen';
$s['latestExperimentalRelease'] = 'A legújabb kísérleti csatornás build';
$s['latestExperimentalReleaseSub'] = 'Némileg megbízhatatlan buildek új ötletekkel és hosszú távú funkciókkal. Ideális lelkes felhasználóknak.';
$s['latestFuturePlatformsRelease'] = 'A legújabb jövőbeli platformok buildje';
$s['latestFuturePlatformsReleaseSub'] = 'Némileg instabil buildek a platform legújabb változtatásaival és korai funkciókkal. Ideális műszakilag magasan képzett felhasználóknak.';
