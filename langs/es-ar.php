...
$s['no'] = 'No';
$s['yes'] = 'Sí';
$s['latestExperimentalRelease'] = 'Última compilación del canal experimental';
$s['latestExperimentalReleaseSub'] = 'Compilaciones algo poco confiables con ideas nuevas y funciones a largo plazo. Ideales para entusiastas.';
$s['latestFuturePlatformsRelease'] = 'Última compilación de Plataformas futuras';
$s['latestFuturePlatformsReleaseSub'] = 'Compilaciones algo inestables con los cambios más recientes de la plataforma y funciones iniciales. Ideales para usuarios muy técnicos.';
