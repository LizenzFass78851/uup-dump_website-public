...
$s['no'] = 'No';
$s['yes'] = 'Sì';
$s['latestExperimentalRelease'] = 'Build più recente del canale sperimentale';
$s['latestExperimentalReleaseSub'] = 'Build alquanto inaffidabili con nuove idee e funzionalità a lungo termine. Ideali per gli appassionati.';
$s['latestFuturePlatformsRelease'] = 'Build più recente delle piattaforme future';
$s['latestFuturePlatformsReleaseSub'] = 'Build alquanto instabili con le modifiche più recenti alla piattaforma e funzionalità iniziali. Ideali per utenti altamente tecnici.';
