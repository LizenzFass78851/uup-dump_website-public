...
$s['no'] = 'Nu';
$s['yes'] = 'Da';
$s['latestExperimentalRelease'] = 'Cea mai recentă versiune a canalului experimental';
$s['latestExperimentalReleaseSub'] = 'Builduri oarecum instabile, cu idei noi și funcții pe termen lung. Ideale pentru entuziaști.';
$s['latestFuturePlatformsRelease'] = 'Cea mai recentă versiune a platformelor viitoare';
$s['latestFuturePlatformsReleaseSub'] = 'Builduri oarecum instabile, cu cele mai recente modificări ale platformei și funcții timpurii. Ideale pentru utilizatori foarte tehnici.';
